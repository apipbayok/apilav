...
export default function FormKorrw() {
              ...
              <CardBody>
                ...
                <Form.Group>
                  ...
                  <Form.Group style={{marginTop:'1.5rem'}}>
                    <Form.Label>Up Link Kordinator Desa</Form.Label>
                    <Form.Select aria-label="Default select" value={user.parent}
                      ...
                      <option key="koid" value="0">Silahkan Pilih Kordinator Desa</option>
                      {lsKordes.map(u => (<option key={u.id} data-segmen={u.segmen_id} data-subsegmen={u.subsegmen_id}
